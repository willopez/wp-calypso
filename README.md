...
2.	Install [`lerna`](https://lernajs.io/) globally: `npm i -g lerna`.
3.	Clone this repository locally.
4.	Add `127.0.0.1 calypso.localhost` to your local `hosts` file.
5.	Execute `npm start` or `npm run dashboard` (for a more visually-oriented interface) from the root directory of the repository.
